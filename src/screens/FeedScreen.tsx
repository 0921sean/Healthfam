...
const styles = StyleSheet.create({
  ...
  deleteBtnText: { fontSize: 13, color: 'rgba(255,255,255,0.7)', fontWeight: '700', textShadowColor: 'rgba(0,0,0,0.4)', textShadowRadius: 4, textShadowOffset: { width: 0, height: 1 } },
  likeBtn: {
    position: 'absolute', bottom: 36, right: 8,
    flexDirection: 'row', alignItems: 'center', gap: 3,
    padding: 4,
  },
  likeEmoji: { fontSize: 18, opacity: 0.5 },
  likeEmojiActive: { opacity: 1 },
  likeCount: { fontSize: 12, color: '#fff', fontWeight: '700', textShadowColor: 'rgba(0,0,0,0.4)', textShadowRadius: 4, textShadowOffset: { width: 0, height: 1 } },
  likeCountActive: { color: '#fff' },
